...
static const char qt_meta_stringdata_ProgressDialog[] = {
    "ProgressDialog\0\0terminateRun()\0"
    "checkFiles()\0toggleDetails()\0file\0"
    "selectedFileChanged(QString)\0"
    "readStepsLog()\0"
};
...
void ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->terminateRun(); break;
        case 1: _t->checkFiles(); break;
        case 2: _t->toggleDetails(); break;
        case 3: _t->selectedFileChanged((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->readStepsLog(); break;
        default: ;
        }
    }
}
