...
public:
    ...
    QHash<QString, QString> id_to_namemap; //  a readable taxon ncbi taxid to name map
    ...
    QString grabNameinQuotes(const QString &name);
...
private:
    ...
    void loadMeganMap(QString mapfile);
