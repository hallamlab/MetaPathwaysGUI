...
enum TYPE {MP_INT, MP_DOUBLE, STRING, UNKNOWN};
enum OPTYPE{ OR, AND};
...
enum SEQNAME {ORFNAME, CONTIGNAME};
...
#else
typedef enum _VALUETYPE { ORFCOUNT, RPKMCOUNT, BASEPWY_ORF, BASEPWY_RPKM,  BASEPWY_RXNTOT,  BASEPWY_RXNCOV} VALUETYPE;
#endif
